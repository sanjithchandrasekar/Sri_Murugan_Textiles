  ...
  return (
    <div style={{ animation:"page3dIn .25s var(--ease-out) both" }}>
      <div className="page-hero">
        ...
        <p>Review your factory-direct selections.</p>
      </div>
      ...
      <section className="sec sec-pt0">
        {cart.length === 0 ? (
          <div style={{ textAlign:"center", padding:"80px 20px", background:"var(--b3)", borderRadius:16, border:"1px solid var(--glass-b)" }}>
            ...
            <h2 style={{ fontSize:"1.8rem", color:"#fff", marginBottom:12, fontFamily:"'Cormorant Garamond', serif" }}>Your cart is empty</h2>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(320px, 1fr))", gap:40 }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              ...
              {cart.map((item, i) => (
                <div key={i} style={{ display:"flex", alignItems:"center", padding:16, background:"var(--b3)", borderRadius:12, border:"1px solid var(--glass-b)", position:"relative" }}>
                  <div style={{ fontSize:"2rem", marginRight:16, background:"var(--b4)", padding:12, borderRadius:8 }}>{item.emoji}</div>
                  <div style={{ flex:1 }}>
                    <div style={{ fontWeight:600, color:"#fff", fontSize:"1.05rem" }}>{item.name}</div>
                    ...
                    <div style={{ marginTop:8, display:"flex", alignItems:"baseline", gap:8 }}>
                      ...
                      <span style={{ color:"rgba(255,255,255,.3)", textDecoration:"line-through", fontSize:".85rem" }}>₹{item.mrp}</span>
                    </div>
                  </div>
            ...
            <div>
              <div style={{ background:"var(--b3)", borderRadius:16, border:"1px solid var(--glass-b)", padding:32, position:"sticky", top:100 }}>
                <h3 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"1.6rem", color:"#fff", marginBottom:24 }}>Order Summary</h3>
                ...
                <div style={{ display:"flex", justifyContent:"space-between", padding:"20px 0", borderTop:"1px solid var(--glass-b)", borderBottom:"1px solid var(--glass-b)", marginBottom:24 }}>
                  <span style={{ fontWeight:600, color:"#fff", fontSize:"1.2rem" }}>Total Amount</span>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                  ...
                  <p style={{ fontSize:".8rem", color:"rgba(255,255,255,.4)", textAlign:"center", marginTop:8 }}>You will be redirected to WhatsApp to confirm availability and sizes.</p>
                </div>

                <div style={{ marginTop:32, display:"flex", flexDirection:"column", gap:12 }}>
                  <div style={{ display:"flex", gap:12, color:"var(--gray-lt)", fontSize:".85rem", alignItems:"center" }}>
                    <Shield size={16} color="var(--red)"/> Secure Factory Direct Processing
                  </div>
                  <div style={{ display:"flex", gap:12, color:"var(--gray-lt)", fontSize:".85rem", alignItems:"center" }}>
